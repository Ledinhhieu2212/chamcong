                ...
                <form action="{{ route('admin.calendar.update', $calendar->id) }}" method="post"
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td><a class="btn bg-primary"
                                                            onclick="openModal('{{ $user->remember_token }}')"><i
                                                                class="fa-solid fa-eye"></i></a></td>
                                                    <div class="body-delete " id={{ "deleteModal-$user->id" }}>
                                                        <div id="form-user-delete">
                                                            ...
                                                            <div class="form-footer">
                                                                <a onclick="closeModal('{{ $user->remember_token }}')"
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <a href="{{ route('admin.calendar.show') }}" class="btn btn-dark">Quay lại</a>
