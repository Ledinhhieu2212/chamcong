<div class="ibox-content">
    <div class="row">
        ...
        <div class="col-lg-2 align-items-end">
            <a href="{{ route('admin.user.create') }}" class="btn btn-danger block"><i class="fa fa-plus"></i> Thêm mới</a>
        </div>
    </div>
        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td class="text-center">
                        <img src="{{ $user->image }}" class="image-avatar" width="100" height="100" alt="Ảnh avatar tài khoản" />
                    </td>
                    <td>
                        <div class="info-item name-item"><strong>Họ và tên:</strong> {{ $user->fullname }}</div>
