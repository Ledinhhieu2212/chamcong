    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="{{ Route::currentRouteName() == 'home' ? 'active' : '' }}">
                <a href="{{ route('home') }}"><i class="fa fa-home"></i> <span class="nav-label">Trang chủ</span>
                </a>

            </li>
            <li class="{{ Route::currentRouteName() == 'user' ? 'active' : '' }}">
                <a href="{{ route('user') }}"><i class="fa fa-user"></i> <span class="nav-label">QL Nhân
                        viên</span> </a>
            ...
            <li class="{{ Route::currentRouteName() }}">
                <a href=""><i class="fa fa-calendar-times-o" aria-hidden="true"></i> <span class="nav-label">QL Chấm công</span> </a>
            </li>
        </ul>
